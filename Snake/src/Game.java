...
public class Game  extends Canvas implements Runnable,KeyListener{
	...
	public void tick() {
		...
		if(new Rectangle(nodeSnake[0].x,nodeSnake[0].y,10,10) .intersects(new Rectangle(ratX,ratY,10,10))) {
			ratX= new Random().nextInt(480-10);
			ratY= new Random().nextInt(480-10);
			score++;
			spd++;
			System.out.println("Pontos: " + score);
			System.out.println("Velociade: " + spd);
		}
